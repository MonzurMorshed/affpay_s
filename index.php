...
<body>
    ...
    <div class="fixed-side-navbar">
        <ul class="nav flex-column">
            <li class="nav-item"><a class="nav-link" href="#home"><span>WELCOME</span></a></li>
            <li class="nav-item"><a class="nav-link" href="#services"><span>ABOUT</span></a></li>
            <li class="nav-item"><a class="nav-link" href="#services"><span>FEATURES</span></a></li>
            <li class="nav-item"><a class="nav-link" href="#services"><span>WORKS</span></a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="#contact-us"><span>CONTACTS</span></a></li>
        </ul>
    </div>

    <img class="img-responsive logo-image" src="img/logo-removebg-preview.png" />

    <form action="" method="post" class="lang">
        <button class="en-btn" type="submit" name="lang" value="english">EN</button>
        <button class="ru-btn" type="submit" name="lang" value="russian">RU</button>
    </form>
    ...
    <div class="parallax-content baner-content" id="home">
        <div class="container">
            <div class="first-content">
                ...
                <div class="primary-btn" style="margin-top:20px;">
                    <a href="#services"><?=$read_more?></a>
                </div>
            </div>
        </div>
    </div>
